...
resid.plot <- ggplot(data=m.var.resid, aes(x=plotdate, y=x)) + 
  geom_line() + labs(x = 'Residuals', y = 'Date', title ='US inflation residuals from VAR(3) model')
resid.plot

acf.plot <- autoplot(resid.acf, main = 'US VAR(3) residuals autocorrelation function')
acf.plot
...
resid.dist.plot <- ggplot(data=m.var.resid, aes(x)) +
  ...
  labs(x = 'Residuals', y = 'Density', title = 'US VAR(3) residuals distribution')
resid.dist.plot
...
autoplot(as.ts(inf), series = 'Data', 
  ...
  xlab('Time Period') + ylab('Inflation')


error.var.us <- fcast.var$mean - test_us[, 2] #Inflation is in column 2
autoplot(error.var.us, main = 'US inflation VAR(3) forecast errors') + 
  xlab('Time Period') + ylab('Prediction error')
```
...
resid.plot <- ggplot(data=m.var.resid, aes(x=plotdate, y=x)) + 
  geom_line() + labs(x = 'Residuals', y = 'Date', title ='EA inflation residuals from VAR(3) model')
resid.plot

acf.plot <- autoplot(resid.acf, main = 'EA VAR(3) residuals autocorrelation function')
acf.plot
...
resid.dist.plot <- ggplot(data=m.var.resid, aes(x)) +
  ...
  stat_function(fun=dnorm,
                ...
                args=list(mean=mean(as.ts(m.var.resid)), 
                          sd=sd(as.ts(m.var.resid)))) +
  labs(x = 'Residuals', y = 'Density', title = 'EA VAR(3) residuals distribution')
resid.dist.plot
...
autoplot(error.var.ea, main = 'EA inflation VAR(3) forecast errors') + 
  xlab('Time Period') + ylab('Prediction error')
```
...
resid.plot <- ggplot(data=m.var.resid, aes(x=plotdate, y=x)) + 
  geom_line() + labs(x = 'Residuals', y = 'Date', title ='NL inflation residuals from VAR(3) model')
resid.plot

acf.plot <- autoplot(resid.acf, main = 'NL VAR(3) residuals autocorrelation function')
acf.plot
...
resid.dist.plot <- ggplot(data=m.var.resid, aes(x)) +
  ...
  stat_function(fun=dnorm,
                ...
                args=list(mean=mean(as.ts(m.var.resid)), 
                          sd=sd(as.ts(m.var.resid)))) +
  labs(x = 'Residuals', y = 'Density', title = 'NL VAR(3) residuals distribution')
resid.dist.plot
...
autoplot(error.var.nl, main = 'NL inflation VAR(3) forecast errors') + 
  xlab('Time Period') + ylab('Prediction error')
```
...
resid.plot <- ggplot(data=m.var.resid, aes(x=plotdate, y=x)) + 
  geom_line() + labs(x = 'Residuals', y = 'Date', title ='CL inflation residuals from VAR(4) model')
resid.plot

acf.plot <- autoplot(resid.acf, main = 'CL VAR(4) residuals autocorrelation function')
acf.plot
...
resid.dist.plot <- ggplot(data=m.var.resid, aes(x)) +
  ...
  stat_function(fun=dnorm,
                ...
                args=list(mean=mean(as.ts(m.var.resid)), 
                          sd=sd(as.ts(m.var.resid)))) +
  labs(x = 'Residuals', y = 'Density', title = 'CL VAR(4) residuals distribution')
resid.dist.plot
...
autoplot(error.var.cl, main = 'CL inflation VAR(4) forecast errors') + 
  xlab('Time Period') + ylab('Prediction error')
```
...
resid.plot <- ggplot(data=m.var.resid, aes(x=plotdate, y=x)) + 
  geom_line() + labs(x = 'Residuals', y = 'Date', title ='MX inflation residuals from VAR(12) model')
resid.plot

acf.plot <- autoplot(resid.acf, main = 'MX VAR(12) residuals autocorrelation function')
acf.plot
...
resid.dist.plot <- ggplot(data=m.var.resid, aes(x)) +
  ...
  stat_function(fun=dnorm,
                ...
                args=list(mean=mean(as.ts(m.var.resid)), 
                          sd=sd(as.ts(m.var.resid)))) +
  labs(x = 'Residuals', y = 'Density', title = 'MX VAR(12) residuals distribution')
resid.dist.plot
...
autoplot(error.var.mx, main = 'MX inflation VAR(12) forecast errors') + 
  xlab('Time Period') + ylab('Prediction error')
```