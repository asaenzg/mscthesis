...
fcast.inputs <- train_us[(N-lags):N,3:L]
...
fcast.inputs <- train_ea[(N-lags):N,3:L]
...
fcast.inputs <- train_nl[(N-lags):N,3:L]
...
fcast.inputs <- train_cl[(N-lags):N,3:L]
...
fcast.inputs <- train_mx[(N-lags):N,3:L]
